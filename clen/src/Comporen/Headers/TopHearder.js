  ...
  return (
    <div className='h-[100px] w-full  bg-white fixed shadow-md z-40'>
      <div className='sm:w-main flex items-center justify-between text-xs m-auto'>
        <div className='m-auto sm:w-main flex justify-between h-[110px] py-[35px]'>
            <Link to='/' className='mt-1 sm:mt-0 max-w-[340px] w-full'>
            ...
            <p className='block sm:hidden text-red-500 mt-1 font-extrabold text-[30px]'>W</p>
            </Link>    
          <div className="flex text-[13px] ">
            ...
            <div className='cursor-pointer flex flex-col sm:px-4 px-2 sm:border-r items-center'>
              <span className='flex items-center'>
                <span className='bg-slate-300 p-3 rounded-l-md' onClick={() => Seach(dataSearch)}><IoIosSearch color='red' size={16} /></span>
                <input onChange={el => setDataSeach(el.target.value)} placeholder='Bạn cần gì?' className='w-[150px] sm:w-[250px] outline-none p-3 rounded-r-md  flex  bg-slate-300 text-gray-100' value={dataSearch} />
              </span>
              <span></span>
            </div>
            ...
            <div onClick={() => dispatch(ShowCart())} className='cursor-pointer flex items-center justify-center  p-2  sm:border-r mr-2'>
